...
public class FourDice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                ImageView dice4Image = (ImageView) findViewById(R.id.dice4);

                dice1.rollDice(dice1Image);
                dice2.rollDice(dice2Image);
                dice3.rollDice(dice3Image);
                dice4.rollDice(dice4Image);

                TextView totalRoll = (TextView) findViewById(R.id.total);

                totalRoll.setText("Roll value is " + String.valueOf(dice1.getRoll() + dice2.getRoll() + dice3.getRoll() + dice4.getRoll()));
